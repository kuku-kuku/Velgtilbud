    ...
    return (
      <div className="min-h-screen bg-offwhite py-8 px-4">
        <div className="max-w-xl mx-auto">
          ...
          <p className="text-center text-xs text-greige mt-4">Velgtilbud.no — Norges ledende markedsplass</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-offwhite py-8 px-4">
        <div className="max-w-xl mx-auto">
          ...
          <p className="text-center text-xs text-greige mt-3">Velgtilbud.no — Norges ledende markedsplass</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-offwhite py-8 px-4">
      <div className="max-w-xl mx-auto">
        ...
        <p className="text-center text-xs text-greige mt-2">Velgtilbud.no — Norges ledende markedsplass</p>
      </div>
    </div>
  )
}
